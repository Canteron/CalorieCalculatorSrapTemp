...
class Temperature:
    ...
    """A scaper that uses an yml file to read the xpath of a value it needs to extract
    ...
    def get(self):
        ...
        .strip elimina los espacios vacios entre el último caracter y las comillas"""

        scraped_content = self._scrape()
        return float(scraped_content['temp'].replace("°C", "").strip())

"""Aqui instanciamos la clase, funcionaria igualmente si silenciamos
la linea if __name__ == "__main__, pero con esto limitamos la ejecución cuando se exporta":"""
